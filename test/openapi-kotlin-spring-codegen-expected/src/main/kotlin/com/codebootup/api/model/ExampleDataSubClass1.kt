...
data class ExampleDataSubClass1(
    ...
    @get:JsonProperty("location", required = false) val location: ExamplePrimitiveClass?,
    @get:JsonProperty("exampleDataClass", required = false) val exampleDataClass: ExampleDataClass?,
